...
void Fase_1(Personagem &player, int t_num){
        ...
        for(int i =0; i < n_enemies; i++){
            ...
            enemies[i].set_max_attack(40);
            enemies[i].set_min_attack(30);
            enemies[i].set_name("Guarda");
        }
        
        Habilidade hab1(" Voadora",30,15);
        //Habilidade hab2 ("pedrada", 20, 6);
        ...
        for( int i = 0; i < n_enemies; i++){
            ...
            if(check == 1){
                ...
                std::cout << "perdeu otario" << std::endl;
                exit(0);
            }else{
                std::cout << "fugiu" << std::endl;
                Fase_1(player, 0);
        }
        }
